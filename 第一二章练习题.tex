...
\end{tabular}
\end{table}	\\
\textbf{C. }该函数从x的最低位开始，与高一位求异或得到的值继续与更高一位求异或得到的值继续与更高一位求异或，直至最高非零位，得到的值与1取与后，返回。	\\[2ex]
\textbf{练习题3.27}	\\[-3ex]
\begin{table}[ht]
\begin{tabular}{m{2em}m{2em}m{2em}l}
...
\{	\\
	...
	&	\multicolumn{3}{l}{for (\underline{\hspace{ 8em }})} 	\\
	&	\multicolumn{3}{l}{\{} 	\\
	&	&	\multicolumn{2}{l}{\underline{\hspace{8em}}} 	\\
	&	\multicolumn{3}{l}{\}} 	\\
	&	\multicolumn{3}{l}{return val;} 	\\
	\multicolumn{3}{l}{\}}	\\
\end{tabular}
