...
\textbf{(1)} 当$0\le ux+uy<2^{31}$时,$U2T_{32}(ux+uy)=ux+uy$，此时$x+y=ux+uy$	\\
\textbf{(2)} 当$2^{31}\le ux+uy<2^{ 32 }$时，$U2T_{32}(ux+uy)=ux+uy-2^{32}$	\\
\textbf{(3)} 当$2^{32}\le ux+uy<2^{33}$时，$U2T_{32}(ux+uy)=U2T_{32}(ux+uy-2^{32})$	\\
